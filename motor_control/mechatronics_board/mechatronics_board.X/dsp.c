...
void fft_fold(int *fft_in, int *fft_out, int size_in, int size_out) {
  /*
      "Folds" a two-sided Fast Fourier transform output vector to create the
  ...
  // "fold" the two-sided vector in half by adding second element to
  // second-to-last element, third element to third-to-last element, etc
